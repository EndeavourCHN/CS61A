...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    num1 = player_score % 10
    num2 = opponent_score // 10 % 10
    return max(3 * abs(num1 - num2), 1)
    # END PROBLEM 2
...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def alwalways_roll_n(score, opponent_score):
        return n
    return alwalways_roll_n
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    max_num = 1
    for i in range(1, 11):
        ave_num = make_averaged(roll_dice, times_called)(i, dice)
        if ave_num > max_avg:
            max_avg = ave_num
            max_num = i
    return max_num
